...
/**
 * Devuelve el tipo elemento de una posición lógica.
 *
 * @param conjunto el primer conjunto.
 * @param posicion_ordinal la posición ordinal para recuperar un item del conjunto.
 * @return un tipo elemento de esa posición o NULL si la posición no es válida.
 */
